...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-01-2025 a las 18:06:25
...
(94, '2025-02-06', '23:00:00', '23:45:00', 1, 9, 'Pendiente', NULL),
(95, '2025-02-20', '22:00:00', '22:45:00', 1, 9, 'Pendiente', NULL),
(96, '2025-02-14', '10:00:00', '10:45:00', 1, 4, 'Pendiente', NULL),
(97, '2025-02-04', '11:00:00', '11:45:00', 1, 4, 'Pendiente', NULL),
(98, '2025-01-31', '17:00:00', '17:45:00', 1, 6, 'Pendiente', 'https://meet.google.com/riu-eimo-qwz'),
(99, '2025-02-07', '23:00:00', '23:45:00', 1, 6, 'Pendiente', 'https://meet.google.com/iqu-wcox-ugo'),
(100, '2025-02-02', '23:00:00', '23:45:00', 1, 6, 'Pendiente', 'https://meet.google.com/sdv-dkds-tep'),
(101, '2025-02-04', '12:00:00', '12:45:00', 1, 5, 'Pendiente', 'https://meet.google.com/baa-ikxw-udi'),
(107, '2025-02-09', '07:00:00', '07:45:00', 1, 5, 'Pendiente', 'https://meet.google.com/dno-smge-frd'),
(117, '2025-02-25', '23:00:00', '23:45:00', 1, 5, 'Pendiente', NULL);
...
(92, 94, 7, 9, 162, '2025-02-06 00:00:00', 'Consulta'),
(93, 95, 7, 9, 163, '2025-02-20 00:00:00', 'Consulta'),
(94, 96, 7, 4, 164, '2025-02-14 00:00:00', 'Consulta'),
(95, 97, 7, 4, 165, '2025-02-04 00:00:00', 'TestConsulta'),
(96, 98, 7, 6, 166, '2025-01-31 00:00:00', 'Consulta Deprecion'),
(97, 99, 7, 6, 168, '2025-02-07 00:00:00', 'depresion'),
(98, 100, 7, 6, 169, '2025-02-02 00:00:00', 'depresion'),
(99, 101, 7, 5, 171, '2025-02-04 00:00:00', 'test12'),
(115, 117, 7, 5, 191, '2025-02-25 00:00:00', 'test60');
...
CREATE TABLE `paciente` (
  ...
  `discapacitado` tinyint(4) DEFAULT NULL,
...
INSERT INTO `paciente` (`id_paciente`, `num_hijos`, `discapacitado`, `descrip_disca`, `id_usuario`, `id_direccion`) VALUES
(2, 0, 0, '', 1, 1),
(4, 4, 1, 'Problemas auditivos', 26, 6),
(5, 2, NULL, NULL, 27, 7),
(6, 5, 1, 'depresion', 28, 8),
(9, 2, NULL, 'Problemas auditivos', 34, 11),
...
CREATE TABLE `paciente_relacion` (
  `id_paciente_relacion` int(11) NOT NULL,
  `id_paciente` int(10) NOT NULL,
  `relacion_familiar` enum('Pareja','Hijo','Sobrino','Ahijado','Otro') NOT NULL,
  ...
  `relacion_discapacitado` tinyint(4) DEFAULT NULL,
  `relacion_descrip_disca` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `paciente_relacion` (`id_paciente_relacion`, `id_paciente`, `relacion_familiar`, `relacion_nombre1`, `relacion_nombre2`, `relacion_apellido1`, `relacion_apellido2`, `relacion_fecha_nac`, `relacion_tipo_doc`, `relacion_numero_doc`, `relacion_discapacitado`, `relacion_descrip_disca`) VALUES
(7, 11, 'Pareja', 'test9', 'test9', 'test9', 'test9', '1999-05-05', 'V', '19853658', 0, NULL),
(8, 9, 'Pareja', 'Test10', 'Test10', 'Test10', 'Test10', '1994-10-16', 'V', '22198821', 0, NULL),
(9, 2, 'Pareja', 'Jose', 'Luis', 'Perez', 'Mendoza', '1996-07-06', 'V', '20145968', 0, 'problemas visuales'),
(14, 5, 'Pareja', 'test15', 'test15', 'test15', 'test15', '1990-01-24', 'V', '20145965', 1, 'test15'),
(16, 5, 'Hijo', 'test60', 'test60', 'test60', 'test60', '2020-07-05', 'V', '222198821', 1, 'test60');
...
(82, 92, 'TRANSFERENCIA BANCARIA', 30, '2025-01-22', 5987),
(83, 93, 'TRANSFERENCIA BANCARIA', 30, '2025-01-22', 454545),
(84, 94, 'TRANSFERENCIA BANCARIA', 30, '2025-01-22', 454545),
(85, 95, 'TRANSFERENCIA BANCARIA', 30, '2025-01-22', 5687),
(86, 96, 'PAGO MOVIL', 20, '2025-01-22', 756832),
(87, 97, 'TRANSFERENCIA BANCARIA', 20, '2025-01-22', 455455),
(88, 98, 'TRANSFERENCIA BANCARIA', 20, '2025-01-22', 4545455),
(105, 115, 'TRANSFERENCIA BANCARIA', 30, '2025-01-22', 7874555);
...
(160, 'pareja', 'online'),
(161, 'pareja', 'online'),
(162, 'individual', 'presencial'),
(163, 'individual', 'presencial'),
(164, 'individual', 'presencial'),
(165, 'individual', 'presencial'),
(166, 'individual', 'online'),
(168, 'individual', 'online'),
(169, 'individual', 'online'),
(177, 'pareja', 'online'),
(191, 'infantil', 'presencial');
...
--
ALTER TABLE `agenda`
  MODIFY `id_agenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `paciente_relacion`
  MODIFY `id_paciente_relacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `pago_cita`
--
ALTER TABLE `pago_cita`
  MODIFY `id_pago_cita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `tipo_cita`
  MODIFY `id_tipo_cita` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
