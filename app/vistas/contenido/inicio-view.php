        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center text-center text-md-left">
                    <img src="<?php echo APP_URL; ?>app/vistas/img/logo.png" alt="Bienvenido" class="img-fluid rounded shadow mx-auto d-block" style="max-width: 200px; height: auto;">
                    ...
                    <div class="d-flex justify-content-start mx-auto d-block">
                        <a href="<?php echo APP_URL; ?>login-paciente/" class="btn btn-light btn-lg mt-3 mr-2">Ingresa</a>
                ...
                <div class="col-md-6" style="position: relative; left: 80px;">
                    <img src="<?php echo APP_URL; ?>app/vistas/img/collage.png" alt="Servicios" class="img-fluid rounded shadow">
                </div>
    ...
    <section id="acercademi" class="py-5">
        <div class="container text-center">
            <div class="perfil-cuadro">
                ...
                <img src="<?php echo APP_URL; ?>app/vistas/img/marce.png" alt="Foto de la psicóloga">
                <p>
