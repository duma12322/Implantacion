    ...
    if ($stmt->execute([':modalidad' => $modalidad, ':id_tipo_cita' => $id_tipo_cita])) {
        ...
        if ($modalidad == 'presencial') {
            if ($tipoUsuario === 'paciente') {
                header("Location: agendar_cita_infantil_presencial.php");
            } elseif ($tipoUsuario === 'administrativo' || $tipoUsuario === 'psicologo') {
                header("Location: agendar_cita_infantil_presencial2.php");
            }
        } else {
    ...
    <div class="container">
        ...
        <div class="col-md-6 mb-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="agendar_cita_infantil.php" method="POST">
