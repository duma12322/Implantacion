    ...
    if ($stmt->execute([':modalidad' => $modalidad, ':id_tipo_cita' => $id_tipo_cita])) {
        ...
        if ($modalidad == 'presencial') {
            if ($tipoUsuario === 'paciente') {
                header("Location: agendar_cita_pareja_presencial.php");
            } elseif ($tipoUsuario === 'administrativo' || $tipoUsuario === 'psicologo') {
                header("Location: agendar_cita_pareja_presencial2.php");
            }
        } elseif ($modalidad == 'online') {
            if ($tipoUsuario === 'paciente') {
                header("Location: agendar_cita_pareja_online.php");
            } elseif ($tipoUsuario === 'administrativo' || $tipoUsuario === 'psicologo') {
                header("Location: agendar_cita_pareja_online2.php");
            }
        }
        exit;
    } else {
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="agendar_cita_pareja.php" method="POST">
